// @ts-check
const CONNECTSTRING = "postgres://lokesvelland@localhost/bib";
const PORT = 3000;
...
const userlist = {
  ...
  4: { id: 4, username: "loke", password: umd5("1212") }
};
const _username2id = { admin: 1, bib1: 2, bib2: 3, loke: 4 };
...
app.post("/runsql", function(req, res) {
  ...
  if (req.isAuthenticated()) {
    ...
    if (user.username === "admin" || user.username === "loke") {
      runsql(res, data);
    } else {
